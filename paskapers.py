...
def parse_formula(chemical_formula: str):
	...
	for element in elements_r:
		...
		for substance in reactants:
			print(substance)
			print(substance.split("."))
			print("dfsfereeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee")
			print(element)
			...
			if element in paska:
				...
				for element2 in elementstuff:
					print("We are at the comparison:")
					print(element2)
					print(elementstuff)
					print(element)
					print(paska)
				...
				'''
				for a in range(len(elementstuff)):
					if element == elementstuff[a]:
						ooflist.append(int(substance.split(".")[a][elementstuff[a].find(element)+len(element):])*-1)
			else:
				ooflist.append(0)
