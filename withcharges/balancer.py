...
def parse_formula(chemical_formula: str):
	...
	print("Matrixthing")
	print(matrixthing)
	add_charges = str(input("Do you want to add charges?: "))
	if add_charges == "y":
		print("Here is the current matrixthing: ")
		print(matrixthing)
		matrixthing.append([int(x) for x in input("Give charges: ").split(" ")])

	print("Paskaaaaaaaaaaaa:::")
